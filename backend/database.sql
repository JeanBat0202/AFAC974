...
VALUES
  (
    ...
    'Cheminée du Tampon',
    < < < < < < < HEAD "/src/assets/Images/Oeuvres/Cheminee_40FI79.jpg",
    '1866-01-01',
    == == == = '/src/assets/Images/Oeuvres/Cheminee_40FI79.jpg',
    '01',
    '01',
    '1866',
    > > > > > > > cae98361d4d9463360316a174c01232f68b026f0 14,
    20,
  ...
  (
    2,
    '40FI78',
    < < < < < < < HEAD 'Arrivée à l\'établissement du Tampon',
    'L\'Établissement',
    ...
    > > > > > > > cae98361d4d9463360316a174c01232f68b026f0 '',
    1,
    1,
    3
  ),
  (
    ...
    "https://view.genial.ly/5fb636d03636f40d7f883f24",
    > > > > > > > cae98361d4d9463360316a174c01232f68b026f0 1,
    3,
    3
  ),
  (
    4,
    '40FI106',
    < < < < < < < HEAD 'Quartier St Pierre. Etablissement de la Rivière, montagnes de l\'Entre Deux',
